...
| MVP-013 | P0 | Implementar pagamento Pix manual em Meus pedidos | Backend → revisão → migration autorizada → Frontend | Backend + Principal + Frontend | Backend e Frontend liberados |
